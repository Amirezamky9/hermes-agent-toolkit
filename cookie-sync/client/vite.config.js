  ...
  plugins: [
    react(),
    {
      ...
      closeBundle() {
        ...
        const hermesSyncSrc = resolve(__dirname, 'src/background/hermes-sync.js');
        const cookieCaptureSrc = resolve(__dirname, 'src/background/cookie-capture.js');
        ...
        const hermesSyncDest = resolve(distDir, 'hermes-sync.js');
        const cookieCaptureDest = resolve(distDir, 'cookie-capture.js');
        ...
        if (existsSync(hermesSyncSrc)) {
          copyFileSync(hermesSyncSrc, hermesSyncDest);
          console.log('Copied hermes-sync.js to dist');
        }
        if (existsSync(cookieCaptureSrc)) {
          copyFileSync(cookieCaptureSrc, cookieCaptureDest);
          console.log('Copied cookie-capture.js to dist');
        }
